...
public class BillingCycleSpecification   {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.baseType, billingCycleSpecification.baseType) &&
        ...
        Objects.equals(this.id, billingCycleSpecification.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(baseType, schemaLocation, type, billingDateShift, billingPeriod, chargeDateOffset, creditDateOffset, description, frequency, href, id, mailingDateOffset, name, paymentDueDateOffset, validFor);
  }
